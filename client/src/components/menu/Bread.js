...
const Bread = () => {
    ...
    const database = [
        { type: "Bread", key: 10, name: "The Cheesy One", desc: "", price: 15, img: cheese, nextItem: "PROTEIN", alt: "Soup with taste of healing", next: "protein" },
        { type: "Bread", key: 11, name: "Hold BAck Vampire", desc: "", price: 15, img: vampire, nextItem: "PROTEIN", next: "protein" },
        { type: "Bread", key: 12, name: "Going Nuts", desc: "", price: 15, img: nuts, nextItem: "PROTEIN", next: "protein" },
        { type: "Bread", key: 13, name: "As Good As It Baguettes", desc: "", price: 15, img: baguette, nextItem: "PROTEIN", next: "protein" },
